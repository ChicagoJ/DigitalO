 ...
 * Generated at: 2017-11-13 06:58:13 UTC
...
public final class bookedRoom_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("<html>\n");
      out.write("<head>\n");
      out.write("<title>Booked Rooms Information</title>\n");
      out.write("<link\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<!-- <td>\n");
      out.write("\t\t\t\t\t\t\t\t\t");
      out.print(RoomDAO.getRoomById(roomId).getDescp() );
      out.write("\n");
      out.write("\t\t\t\t\t\t\t\t</td> -->\n");
      out.write("\t\t\t\t\t\t\t\t\n");
      out.write("\t\t\t\t\t\t\t\t<td>\n");
      out.write("\t\t\t\t\t\t\t\t\t");
      out.print(RoomDAO.getRoomById(roomId).getPrice() );
      out.write("\n");
      out.write("\t\t\t\t\t\t\t\t</td>\n");
      out.write("\t\t\t\t\t\t\t\t\n");
      out.write("\t\t\t\t\t\t\t\t<td>\n");
      out.write("\t\t\t\t\t\t\t\t\t");
      out.print(RoomDAO.getRoomById(roomId).getDiscount() );
      out.write("\n");
      out.write("\t\t\t\t\t\t\t\t</td>\n");
      out.write("\t\t\t\t\t\t\t\t\n");
      out.write("\t\t\t\t\t\t\t\t<td>\n");
      out.write("\t\t\t\t\t\t\t\t\t");
      out.print(room.getCheckinDate() );
      out.write("\n");
      out.write("\t\t\t\t\t\t\t\t</td>\n");
      out.write("\t\t\t\t\t\t\t\t<td>\n");
      out.write("\t\t\t\t\t\t\t\t\t");
      out.print(room.getCheckoutDate() );
      out.write("\n");
      out.write("\t\t\t\t\t\t\t\t</td>\n");
      out.write("\t\t\t\t\t\t\t</tr>\n");
      out.write("\t\t\t\t\t");
